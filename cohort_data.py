...
def all_houses(filename):
  ...
  # hag_file = open("cohort_data.txt")
  
  # list_of_houses = []
  
  # records = hag_file.split("\n")
  # records should look like this:
  # records = ["Harry", "Potter", "Housename"]
  # for line in hag_file:
    # for word in line:

    #   list_of_houses.append(word[2])
    # line.split("\n") #spilts and then makes it into a list
    # list_of_houses.append(line[2][0])

  # houses = set(list_of_houses)
  # return houses
